...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Craigcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"craigcointools.com", "craigcointools.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"craigcointools.com", "testnet-seed.craigcointools.com"},
    {"xurious.com", "testnet-seed.crac.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Craigcoin is probably already running."), addrBind.ToString().c_str());
        else
